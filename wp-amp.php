    ...
    class AMPHTML {
        ...
        public function get_search_redirect_url() {
            if ( get_query_var( 's' ) ) {
                ...
                $url    = '/' . 'search' . '/' . $search . '/' . $this->get_endpoint() . '/';
            } else {
        ...
        public function check_license( $whitelist_options ) {
            if ( $_POST['tab'] == 'license' && $_POST['action'] == 'update' ) {
                global $license_box_api;
                $license_code = $_POST['amphtml_license_code'];
                $license_name = $_POST['amphtml_license_name'];
                if ( empty( $license_code ) )
                    $license_code = 'null';
                if ( empty( $license_name ) )
                    $license_name = 'null';
                $result       = $license_box_api->check_license( $license_code, $license_name );
