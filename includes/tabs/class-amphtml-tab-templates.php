		...
		$fields = array (
			...
			array (
				...
				'description'           => __( 'Show excerpt', 'amphtml' ),
            			...
            			// Search form
			array (
				'id'                    => 'search_search_form',
				'title'                 => __( 'Search Form', 'amphtml' ),
				'default'               => 0,
				'section'               => $section,
				'display_callback'      => array ( $this, 'display_checkbox_field' ),
				'display_callback_args' => array ( 'search_search_form' ),
				'description'           => __( 'Enable search form. Needs SSL certificate for AMP validation.', 'amphtml' )
			),
		);
		...
		$fields = array (
			...
			array (
				...
				'description'           => __( 'Show excerpt', 'amphtml' ),
            			...
            			// Search form
			array (
				'id'                    => 'blog_page_search_form',
				'title'                 => __( 'Search Form', 'amphtml' ),
				'default'               => 0,
				'section'               => $section,
				'display_callback'      => array ( $this, 'display_checkbox_field' ),
				'display_callback_args' => array ( 'blog_page_search_form' ),
				'description'           => __( 'Enable search form. Needs SSL certificate for AMP validation.', 'amphtml' )
			),
		);
	...
	public function get_archive_fields( $section ) {
		...
		$fields = array (
			...
			array (
				...
				'section'               => $section,
				'display_callback'      => array ( $this, 'display_checkbox_field' ),
				'display_callback_args' => array ( 'archive_search_form' ),
				'description'           => __( 'Enable search form. Needs SSL certificate for AMP validation.', 'amphtml' )
			),
		);
