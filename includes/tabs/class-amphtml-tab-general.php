...
class AMPHTML_Tab_General extends AMPHTML_Tab_Abstract {
	...
	public function get_fields() {                
		return array (
            ...
            array (
				...
				'default'               => 0,
				'display_callback'      => array ( $this, 'display_checkbox_field' ),
				'display_callback_args' => array ( 'is_hidden_contact_forms' ),
			...
			array (
                ...
                'display_callback_args' => array ( 'length_excerpt' ),
	...
	public function get_default_archives() {
		...
		$archives = array_merge( $archives, $this->get_default_post_types( array ( 'public'      => true,
		                                                                   'has_archive' => true
		) ) );
    ...
    public function get_default_post_types( $args = '' ) {
		$types        = array ();
		$default_args = array (
			'public' => true
		);
