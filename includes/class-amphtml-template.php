...
class AMPHTML_Template extends AMPHTML_Template_Abstract {
    ...
    public function get_element_colors() {
        ...
        if ( amphtml_is_new_design() ) {
            ...
            return "body {background:{$body_bg};color:{$main_text_color}}" .
                    ...
                    "a, nav.breadcrumb ul li, .amphtml-content ul:not([class]) li::before, .amphtml-single-post ul:not([class]) li::before, .amphtml-single-post blockquote::before, .amphtml-single-product .star, .products .product-card .star, .related-products-container .wc-related-start, .amphtml-readmore, .amp-reviews > li article .comment-meta .comment-author b{color:{$link_text}} a:hover{color:{$link_text_hover}}" .
                    ...
                    "input[type=text],input[type=email],input[type=password],input[type=number],input[type=search],input[type=tel], select, textarea{color:{$inputs_color};border-color:{$inputs_color}}" .
    ...
    public function get_custom_css() {
        ...
        if ( amphtml_is_new_design() ) {
            echo PHP_EOL . ".footer .inner { max-width: {$content_width}px; margin: 0 auto;}" . "#main .inner { max-width: {$main_content_width}px; } " . $this->get_element_fonts() . $this->get_element_colors();
        } else {
    ...
    public function load() {
        ...
        switch ( true ) {
            ...
            case is_single():
                ...
                if ( $this->options->get( 'social_like_button' ) && $this->options->get( 'post_social_share' ) ) {
                    $this->add_embedded_element( $social_like_script );
                }
                break;
            case is_page():
